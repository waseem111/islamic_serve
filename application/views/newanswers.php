		...
		<div class="row">
			<aside class="col-md-4 sidebar">
				<div class="widget widget_stats">
					<h3 class="widget_title">Safar Selections</h3>
			...
			<div class="col-md-8">
				...
				<article class="question question-type-normal">
					...
					<a class="question-report" href="#">Question</a>
					
					<div class="question-inner" style="    margin-left: 0px;">
				...
				<div class="divider"  style="padding-top: 30px;"><span></span></div>
